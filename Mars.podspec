...
Pod::Spec.new do |s|
  s.name             = "Mars"
  s.version          = "0.1.0"
  s.summary          = "A short description of Mars.xx"
...
TODO: Add long description of the pod here.aaa
  ...
  s.homepage         = "https://github.com/yishuiliunian/Mars"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "stonedong" => "yishuiliunian@gmail.com" }
  s.source           = { :git => "https://github.com/yishuiliunian/Mars.git", :tag => s.version.to_s }
